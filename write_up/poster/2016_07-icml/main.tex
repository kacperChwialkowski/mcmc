...
we apply our goodness of fit test to measuring
quality-of-fit in nonparametric density estimation. We evaluate two
density models: the infinite dimensional exponential family \cite{SriFukKumGreHyv14},
and a recent approximation to this model using random Fourier features
\cite{strathmann2015gradient}.
% 
\footnotesize

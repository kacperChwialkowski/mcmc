...
\item Tada
\end{center}
\includegraphics[width=0.48\textwidth]{../../presentation/img/increasing_data_fixed_test.pdf} \includegraphics[width=0.48\textwidth]{../../presentation/img/increasing_features_fixed_test.pdf} 
\begin{minipage}{.35\linewidth}
